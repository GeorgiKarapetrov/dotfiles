...
Paste the words here => split 65-million plummeting race dinosaurs

2. You copied all the words pretty well. Now, from the same block above, copy the second line and paste it below.

Paste the line here => wiped out the entire 'race' of 'dinosaurs'.
...
Paste all the words here => dinosaurs race plummeting 65-million split
