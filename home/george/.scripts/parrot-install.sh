...
function core_install() {
	echo -e "deb http://ftp-stud.hs-esslingen.de/pub/Mirrors/archive.parrotsec.org/ stable main contrib non-free" > /etc/apt/sources.list.d/parrot.list
	#https://cdimage.parrotsec.org/parrot/iso/4.5.1/Parrot-security-4.5.1_amd64.iso.mirrorlist
	#https://www.parrotsec.org/docs/mirror-list/
	#echo -e "deb http://mirrors.mit.edu/parrot/ stable main contrib non-free" > /etc/apt/sources.list.d/parrot.list
